...
# Project requested by Professor Fabiano @ Faculdade CESUSC - Software Engineering Diploma
...
def atualizar():
    try:
        ...
        def update():
            ...
            lista_atualizar = [material, codigo_titulo, titulo, numero_de_chamada, data_publicacao, autor, forma_aquisicao, data_aquisicao, fornecedor, preco,id]
